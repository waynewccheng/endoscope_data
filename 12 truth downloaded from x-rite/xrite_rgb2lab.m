%% Convert X-Rite published RGB to LAB

function xrite_rgb2lab
...
% save as a file
rgbxrite = rgb24x3;
save('rgbxrite','rgbxrite')

% normalize to 1
rgb24x3_normalized = rgb24x3/255;

% store in a 24x3 matrix
labxrite = zeros(24,3);
for i = 1:24
    labxrite(i,:) = srgb2lab(rgb24x3_normalized(i,:));
end

% save as a file
save('labxrite','labxrite')
